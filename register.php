   	    	...
   	    	<div class="col-sm-4 login_left">
	        	<form>
					<div class="form-group">
						<label for="edit-name">Enter your mobile number <span class="form-required" title="This field is required.">*</span></label>
						<input type="number" id="phone" name="phone" for value=""  class="form-text required">
					</div>
					<!--<div class="form-group">
