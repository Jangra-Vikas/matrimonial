                                ...
                                <div class="basic_1">
                                    ...
                                    <div class="col-md-6 basic_1-left">
                                        <table class="table_working_hours">
                                            <tbody>
                                            <tr class="opened">
                                                <td class="day_label">Height (In Feet) :</td>
                            ...
                            <div class="basic_1">
                                ...
                                <div class="col-md-6 basic_1-left">
                                    <table class="table_working_hours">
                                        <tbody>
                                        <tr class="opened_1">
                                            <td class="day_label">InterestsBooks</td>
                                            <td class="day_value">Hindu</td>
                                        </tr>
                                        <tr class="opened">
                            ...
                            <div class="basic_1">
                                ...
                                <div class="col-md-6 basic_1-left">
                                    <table class="table_working_hours">
                                        <tbody>
                                        <tr class="opened">
                                            <td class="day_label">Affection :</td>
                                            <td class="day_value">Not Specified</td>
                                        </tr>
                                        <tr class="opened">
                                ...
                                <div class="col-md-6 basic_1-left">
                                    <table class="table_working_hours">
                                        <tbody>
                                        <tr class="opened_1">
                                            <td class="day_label">Political Views</td>
                                            <td class="day_value">Hindu</td>
                                        </tr>
                                        <tr class="opened">
                                ...
                                <div class="basic_1 basic_2">
                                    <div class="basic_1-left">
                                        <table class="table_working_hours">
                                            <tbody>
                                            <tr class="opened">
                                                <td class="day_label">General Requirement :</td>
